...
export default {
  ...
  methods: {
    ...
    // ...mapMutations('user', ['setToken', 'setRefresh']),
    login() {
      const userData = {
      ...
      api.token(userData)
        .then(response => {
          ...
          this.$router.push('/')
          console.log('[ OK ] = Datos Guardados')
        })
        .catch(error => {
    ...
    loogin() {
      useJwt.login({
        ...
        .then(response => {
          ...
          this.$router.push('/prebecarios-seleccion')
          console.log('[ OK ] = Datos Guardados')
        })
        .catch(error => {
          console.log(`[ ERROR ] = ${error}`)
